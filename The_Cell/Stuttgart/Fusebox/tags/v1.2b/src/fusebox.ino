...
const String title = String("FUSEBOX S v1.2");
...
void setup() {
    ...
    // -- tie into default library of sorts
    for (int i = 0; i < sizeof(relayInitArray); i++) {
        relay.digitalWrite(relayPinArray[i], 1);
        delay(100);
...
void loop() {
    ...
    Serial.println("passwordCheckup \n");
    Serial.print(passwordCheckup);
...
bool relay_Init() {
    ...
    relay.digitalWrite(REL_8_PIN, HIGH);
