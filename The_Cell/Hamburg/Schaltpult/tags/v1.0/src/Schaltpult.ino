 ...
 *		by Robert Schloezer & Abdullah Saei
 *
 *		v1.0 beta
 *		-
 *		-
...
const String title = String("SCHALTPULT v1.0 beta");


/*==INCLUDE=================================================================================================*/
// I2C Port Expander
#include "PCF8574.h"                  /* https://github.com/skywodd/pcf8574_arduino_library - modified!  		*/
                                      /* Classname was changed because of name conflicts!										*/
...
// ______________________EINSTELLUNGEN______________________
	...
	// Keypad
		#define KEYPAD_I2C_ADD       0x38     /* moeglich sind 0x38, 0x39, 0x3A, 0x3B, 0x3D                 */
...
const int UpdateOLEDAfterDelay = 5000;         /* Time, until the Display refreshes and flickers,
 																									just for knowning that the Arduino is still working				*/
