...
#------------------------ Hintergrundbild ------------------------
bg_image_de = PhotoImage(file ="/home/pi/fingerabdruck/img/misc/de_background_st.png")
bg_de = Label (window, image = bg_image_de)
bg_image_en = PhotoImage(file ="/home/pi/fingerabdruck/img/misc/en_background_st.png")
...
beweismittel1 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel2 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel3 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel4 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel5 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel6 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
beweismittel7 = MyOptionMenu(loginframe, textSTD, "Becher", "Kuli", "Reiseführer", "Süßstoff", "Tabletten", "Zigaretten", "Zucker")
# Person 1
...
proof1 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof2 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof3 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof4 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof5 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof6 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
proof7 = MyOptionMenu(loginframe, textSTD_en, "Cigarettes", "Cup", "Guidebook", "Pen", "Pills", "Sugar", "Sweetener")
# Person 1
...
def check_beweismittel():    
    if(beweismittel1.var).get()=="Becher" and\
        ...
        (beweismittel5.var).get()=="Zigaretten" and\
        ...
        (beweismittel6.var).get()=="Zigaretten" and\
        (beweismittel7.var).get()=="Kuli":
        var_beweismittel = 2
    else:
        var_beweismittel = 0
